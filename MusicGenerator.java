...
public class MusicGenerator {
	...
	public void playMusic(Vector<Float> numbers) {
		...
		if(mode == 0) {//play arpeg numbers multiplying each other
			float f =  ((float)numbers.size()*2.0f+Math.abs(numbers.get((int)( (rand.nextInt(numbers.size()))))));
		...
		if(mode == 1) {//play note exp low frequency number
			...
			sequence= new Vector<Float>((int)f);
			for(int i = 0; i<f;i++) {
				float c = numbers.get(( (int)( (rand.nextInt(numbers.size())))))*(55.0f/numberAssigned);
		...
		if(mode == 6) {//play note exp low frequency number
			...
			sequence= new Vector<Float>((int)f);
			for(int i = 0; i<f;i++) {
				float c = (numbers.get( (int)( (rand.nextInt(numbers.size()))))*numbers.get((int)( (rand.nextInt(numbers.size())))))*(55.0f/numberAssigned);
				sequence.add(i,(float) Math.pow(c, numberAssigned));
				if(sequence.get(i)==null) {
					System.out.println("\n"+sequence.get(i));
				}
		...
		if(mode == 7) {//play note exp low frequency number multiplied 3 nums
			...
			sequence= new Vector<Float>((int)f);
			for(int i = 0; i<f;i++) {
				float c = (numbers.get((int)( ( rand.nextInt(numbers.size()))))*numbers.get((int)( (rand.nextInt(numbers.size()))))*numbers.get(numbers.size()-1-(int)( (rand.nextInt(numbers.size())))))*(55.0f/numberAssigned);
				sequence.add(i,(float) Math.pow(c, numberAssigned));
				if(sequence.get(i)==null) {
					System.out.println("\n"+sequence.get(i));
				}
		...
		if(mode == 10) {//play note exp low frequency number
			...
			sequence= new Vector<Float>((int)f);
			for(int i = 0; i<f;i++) {
				float c = numbers.get((numbers.size()-1-(int)( (rand.nextInt(numbers.size())))))*(55.0f/numberAssigned);
				sequence.add(i,(float) Math.pow(c, numberAssigned));
				if(sequence.get(i)==null) {
					System.out.println("\n"+sequence.get(i));
				}
		...
		if(mode == 15) {//play note exp low frequency number
			...
			sequence= new Vector<Float>((int)f);
			for(int i = 0; i<f;i++) {
				float c = (numbers.get(numbers.size()-1-(int)( (rand.nextInt(numbers.size()))))*numbers.get((int)( (rand.nextInt(numbers.size())))))*(55.0f/numberAssigned);
				sequence.add(i,(float) Math.pow(c, numberAssigned));
				if(sequence.get(i)==null) {
					System.out.println("\n"+sequence.get(i));
				}
		...
		if(mode == 16) {//play note exp low frequency number multiplied 3 nums
			...
			sequence= new Vector<Float>((int)f);
			for(int i = 0; i<f;i++) {
				float c = (numbers.get(numbers.size()-1-(int)( (rand.nextInt(numbers.size()))))*numbers.get((int)( (rand.nextInt(numbers.size()))))*numbers.get( (int)( (rand.nextInt(numbers.size())))))*(55.0f/numberAssigned);
				sequence.add(i,(float) Math.pow(c, numberAssigned));
				if(sequence.get(i)==null) {
					System.out.println("\n"+sequence.get(i));
				}
