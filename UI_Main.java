	...
	public void draw() {
		...
		while (!done) {
			...
			for (int b = 0; b < numbers.size(); b++) {
				...
				Oscs.get(b).get(0).play(110, (float) 1.0f / (float) (numbers.size() * 4));
				Oscs.get(b).get(1).play(110 / (numbers.get(b)), (float) 1.0f / (float) (numbers.size() * 6));
				Oscs.get(b).get(2).play(110 / (1.0f + abs(pow(numbers.get(b), 2.0f))),
						(float) 1.0f / (float) (numbers.size() * 10));
			...
			if (interpreter.instruments.get(i).sequence.size() != 0) {
				...
				if ((millis() > interpreter.instruments.get(i).trigger) && j == 1) {
					translate(2046 - 6 * interpreter.instruments.get(i).sequence.get(note.get(i).intValue() - 1) / 100,
							...
							-interpreter.instruments.get(i).numberAssigned - 256
									* interpreter.instruments.get(i).sequence.get(note.get(i).intValue() - 1) / 1000);
				...
				if ((millis() > interpreter.instruments.get(i).trigger) && j == 2) {
					translate(
							2046 - note.get(i).intValue() * 24
									* interpreter.instruments.get(i).sequence.get(note.get(i).intValue() - 1) / 6000,
							-1024 + 6 * interpreter.instruments.get(i).sequence.get(note.get(i).intValue() - 1) / 100,
							-interpreter.instruments.get(i).numberAssigned - 256
									* interpreter.instruments.get(i).sequence.get(note.get(i).intValue() - 1) / 1000);
					rotateX((float) -(numbers.get(i) * millis() * 0.001f * time));
					rotateY((float) (numbers.get(i) * millis() * 0.001f * time));
				...
				if ((millis() > interpreter.instruments.get(i).trigger) && j == 5) {
					translate(
							note.get(i).intValue() * 24
									* interpreter.instruments.get(i).sequence.get(note.get(i).intValue() - 1) / 6000,
							-6 * interpreter.instruments.get(i).sequence.get(note.get(i).intValue() - 1) / 100,
							-interpreter.instruments.get(i).numberAssigned - 256
									* interpreter.instruments.get(i).sequence.get(note.get(i).intValue() - 1) / 1000);
					rotateX((float) -(numbers.get(i) * millis() * 0.001f * time));
					rotateY((float) (numbers.get(i) * millis() * 0.001f * time));
				...
				if ((millis() > interpreter.instruments.get(i).trigger)
					...
					Oscs.get(i).get(0).set(((noteFreq/16.0f)), ((float) 1.0f / (float) (numbers.size() * 4))*(1.0f/(1.0f+(((noteFreq/16.0f))/16782.1f)/((((noteFreq/16.0f))/8.0f)/26782.1f))), 0, 0);
					Oscs.get(i).get(1).set(((noteFreq/16.0f)) * ((numbers.get(i)+(1.0f/numbers.get(i)))), ((float) 1.0f / (float) (numbers.size() * 4))*(1.0f/(1.0f+2.0f*(((noteFreq/16.0f))/16782.1f)/(((noteFreq/16.0f))/26782.1f))), 0,
							0);
					Oscs.get(i).get(2).set(((noteFreq/16.0f)) * (Math.abs(pow((numbers.get(i)+(1.0f/numbers.get(i))), 2.0f))),
							((float) 1.0f / (float) (numbers.size() * 4))*(1.0f/(1.0f+4.0f*(((noteFreq/16.0f))/16782.1f)/(((noteFreq/16.0f))/26782.1f))), 0, 0);
					Oscs.get(i).get(3).set(((noteFreq/16.0f)) * (Math.abs(pow((numbers.get(i)+(1.0f/numbers.get(i))), 2.0f*(numbers.get(i)+(1.0f/numbers.get(i)))))),
